...
import com.faturium.domain.model.Pedido;
...
public interface PedidoRepository extends PertenceOrganizacaoRespository<Pedido, UUID> {
    ...
    @Query("select e from Pedido e where e.organizacao.idOrg = :organizacaoId and e.status != com.faturium.domain.model.Status.INATIVO and e.user.login = :username")
